...
namespace Kits.ClientKit.Handlers.LoopSystems
{
    ...
    /// </summary>
    public static class PlayerLoopHandler
    {
        /// <summary>
        ...
        public static bool RegisterUpdate<TSystem, TSubSystem>(PlayerLoopSystem.UpdateFunction update, int index = -1)
        {
            ...
            if (!loop.TryFindSubSystem<TSystem>(out PlayerLoopSystem system))
            {
                return false;
            }

            if (system.TryFindSubSystem<TSubSystem>(out PlayerLoopSystem subSystem))
            {
            ...
            else
            {
                ...
                int subSystemCount = subSystems != null ? subSystems.Length : 0;
        ...
        public static void DeregisterUpdate<TSubSystem>(PlayerLoopSystem.UpdateFunction update)
        {
            ...
            if (loop.TryFindSubSystem<TSubSystem>(out PlayerLoopSystem subSystem))
            {
                subSystem.updateDelegate -= update;
        ...
        {
            PlayerLoopSystem[] subSystems = system.subSystemList;
            int oldLength = subSystems != null ? subSystems.Length : 0;
            ...
            PlayerLoopSystem[] newSubSystems = new PlayerLoopSystem[oldLength + 1];
