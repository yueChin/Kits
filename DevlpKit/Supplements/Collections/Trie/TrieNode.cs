...
namespace Kits.DevlpKit.Supplements.Collections.Trie
{
    ...
    public class TrieNode
    {
        ...
        public virtual IEnumerable<String> GetByPrefix()
        {
            ...
            foreach (KeyValuePair<char, TrieNode> childKeyVal in Children)
                foreach(string terminalNode in childKeyVal.Value.GetByPrefix())
        ...
        public virtual IEnumerable<TrieNode> GetTerminalChildren()
        {
            foreach (TrieNode child in Children.Values) {
                ...
                foreach (TrieNode grandChild in child.GetTerminalChildren())
