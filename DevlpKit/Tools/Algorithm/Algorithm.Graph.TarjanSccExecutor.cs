    ...
    public static partial class Algorithm
    {
        ...
        public static partial class Graph
        {
            private class TarjanSccExecutor<K, V>
            {
                ...
                public void Execute()
                {
                    foreach (KeyValuePair<K, V> kv in m_Vertices)
                    {
                ...
                private void Recur(K key)
                {
                    ...
                    V vertex = m_Vertices[key];
                    IEnumerable<K> successorKeys = m_GetSuccessorKeysFunc(vertex);
                    if (successorKeys != null)
                    {
                        foreach (K successorKey in successorKeys)
                        {
